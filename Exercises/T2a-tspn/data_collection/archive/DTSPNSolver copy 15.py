        ...
        for point2 in range(number_of_points):
            ...
            for sample1 in range(len(samples[point1])):
                for sample2 in range(len(samples[point2])):
                    ...
                    distance = dubins.shortest_path(pose_to_se2(samples[point1][sample1]), pose_to_se2(samples[point2][sample2]), turning_radius).path_length()
                    distances2[point1*samples_per_point+sample1][point2*samples_per_point+sample2] = distance
                    const_M = max(const_M, distance)
    print("NOW")                    
